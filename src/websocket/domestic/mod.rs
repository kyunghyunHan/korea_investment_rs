...
pub enum DomesticRealtimeInfoType {
    ...
    ElwQuote,
    ElwExpected,
    CommodityFuturesTrade,
    CommodityFuturesQuote,
    FutureOptionNotification,
    FuturesExpected,
    IndexFuturesTrade,
    IndexFuturesQuote,
    IndexOptionTrade,
    IndexOptionQuote,
    KrxNightFuturesQuote,
    KrxNightFuturesTrade,
    KrxNightFuturesNotification,
    KrxNightOptionQuote,
    KrxNightOptionTrade,
    KrxNightOptionExpected,
    KrxNightOptionNotification,
    OptionExpected,
    StockFuturesTrade,
    StockFuturesQuote,
    StockOptionQuote,
...
impl DomesticRealtimeInfoType {
    pub fn get_name(&self) -> &'static str {
        match self {
            ...
            Self::CommodityFuturesTrade => "상품선물 실시간체결",
            Self::CommodityFuturesQuote => "상품선물 실시간호가",
            Self::FutureOptionNotification => "선물옵션 실시간체결통보",
            Self::FuturesExpected => "선물 실시간예상체결",
            Self::IndexFuturesTrade => "지수선물 실시간체결",
            Self::IndexFuturesQuote => "지수선물 실시간호가",
            Self::IndexOptionTrade => "지수옵션 실시간체결",
            Self::IndexOptionQuote => "지수옵션 실시간호가",
            Self::KrxNightFuturesQuote => "KRX야간선물 실시간호가",
            Self::KrxNightFuturesTrade => "KRX야간선물 실시간체결",
            Self::KrxNightFuturesNotification => "KRX야간선물 실시간체결통보",
            Self::KrxNightOptionQuote => "KRX야간옵션 실시간호가",
            Self::KrxNightOptionTrade => "KRX야간옵션 실시간체결",
            Self::KrxNightOptionExpected => "KRX야간옵션 실시간예상체결",
            Self::KrxNightOptionNotification => "KRX야간옵션 실시간체결통보",
            Self::OptionExpected => "옵션 실시간예상체결",
            Self::StockFuturesTrade => "주식선물 실시간체결",
            Self::StockFuturesQuote => "주식선물 실시간호가",
            Self::StockOptionQuote => "주식옵션 실시간호가",
            Self::StockOptionTrade => "주식옵션 실시간체결",
        }
    }
    ...
    pub fn get_tr_code(&self) -> &'static str {
        match self {
            ...
            Self::CommodityFuturesTrade => "H0CFCNT0",
            Self::CommodityFuturesQuote => "H0CFASP0",
            Self::FutureOptionNotification => "H0IFCNI0",
            Self::FuturesExpected => "H0ZFANC0",
            Self::IndexFuturesTrade => "H0IFCNT0",
            Self::IndexFuturesQuote => "H0IFASP0",
            Self::IndexOptionTrade => "H0IOCNT0",
            Self::IndexOptionQuote => "H0IOASP0",
            Self::KrxNightFuturesQuote => "H0MFASP0",
            Self::KrxNightFuturesTrade => "H0MFCNT0",
            Self::KrxNightFuturesNotification => "H0MFCNI0",
            Self::KrxNightOptionQuote => "H0EUASP0",
            Self::KrxNightOptionTrade => "H0EUCNT0",
            Self::KrxNightOptionExpected => "H0EUANC0",
            Self::KrxNightOptionNotification => "H0EUCNI0",
            Self::OptionExpected => "H0ZOANC0",
            Self::StockFuturesTrade => "H0ZFCNT0",
            Self::StockFuturesQuote => "H0ZFASP0",
            Self::StockOptionQuote => "H0ZOASP0",
            Self::StockOptionTrade => "H0ZOCNT0",
        }
    }
}
